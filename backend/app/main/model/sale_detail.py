...
class SaleDetail(db.Model):
    ...
    product_value = db.Column(db.String(12), nullable=False, info={'comment': 'Precio de venta del producto en esta transacción'})
    iva_calculated = db.Column(db.String(12), nullable=True, info={'comment': 'Valor del IVA calculado para este producto'})
